...
**This project** will investigate land cover and use changes in Brazilian tropical forests, evaluating their relationship to indigenous, forestry, environmental, and tenure policies. The focus will be on the last 50 years in the Amazon and Atlantic Forest biomes. The study will use policy analysis, geospatial and geostatistical tools to map legislative areas of influence over the decades and their connection to land usage tendencies.

Eight case studies of Indigenous Reserves and Environmental Conservation Units will be further evaluated, comparing a buffer area around them without the same protection rules. The steps of this analysis will result in policy and land cover layers for an interactive map where users can understand the historical trends and policy effectiveness. This tool will help interpret previous human and ecological impacts and contribute to future management of natural vegetation protection and forest resiliency.

The following maps illustrate the motivation behind this study, tracing the historical land occupation of Brazil from the 1500s to the present day. The policies evolved in response to colonization and the impact on indigenous populations. Some areas have another tendency from 1937 with the creation of Itatiaia National Park and 1961 with the creation of Parque do Xingu, the first Brazilian indigenous reserve. Following the national overview, detailed maps explain the origins of the case studies and why eight regions around those reserves are particularly interesting for understanding the interplay between forests, human populations, and public policies over time.

These regions show the land use trends in older coastal and interior protected and non-protected areas, as well as nearby recently created reserves with territorial conflicts. These examples will illustrate the historical customary influence of Brazilian peoples over law and land.
...
- [A.2 Atlantic Forest Case Studies](#a2-atlantic-forest-case-studies)
    - [A.2.1 South Bahia and Espírito Santo (Atlantic Forest Case Study 1)](#a21-south-bahia-and-espírito-santo-atlantic-forest-case-study-1)
    - [A.2.2 São Paulo Coast (Atlantic Forest Case Study 2)](#a22-são-paulo-coast-atlantic-forest-case-study-2)
    - [A.2.3 Southern São Paulo and Northern Paraná Coast (Atlantic Forest Case Study 3)](#a23-southern-são-paulo-and-northern-paraná-coast-atlantic-forest-case-study-3)
- [A.3 Amazon-Cerrado Transition Case Studies](#a3-amazon-cerrado-transition-case-studies)
    - [A.3.1 Maranhão (Amazon Case Study 1)](#a31-maranhão-amazon-case-study-1)
    - [A.3.2 Mato Grosso (Amazon Case Study 2)](#a32-mato-grosso-amazon-case-study-2)
- [A.4 Amazon Interior Case Studies](#a4-amazon-interior-case-studies)
    - [A.4.1 Eastern Pará (Amazon Case Study 3)](#a41-eastern-pará-amazon-case-study-3)
    - [A.4.2 Central Amazon (Amazon Case Study 4)](#a42-central-amazon-amazon-case-study-4)
    - [A.4.3 Western Amazon (Amazon Case Study 5)](#a43-western-amazon-amazon-case-study-5)
- [A.5 National Context: Protected Areas in Brazil](#a5-national-context-protected-areas-in-brazil)
    - [A.5.1 Classification and Chronology of Protected Areas](#a51-classification-and-chronology-of-protected-areas)
    - [A.5.2 Historical Land Coverage in Protected Areas](#a52-historical-land-coverage-in-protected-areas)
    - [A.5.3 Historical Land Coverage in Non-Protected Areas](#a53-historical-land-coverage-in-non-protected-areas)
    - [A.5.4 Deforestation Patterns (2000-Present)](#a54-deforestation-patterns-2000-present)
- [A.6 Case Study Selection Methodology](#a6-case-study-selection-methodology)
...
## A.2 Atlantic Forest Case Studies

### A.2.1 South Bahia and Espírito Santo (Atlantic Forest Case Study 1)
...
### A.2.2 São Paulo Coast (Atlantic Forest Case Study 2)
...
### A.2.3 Southern São Paulo and Northern Paraná Coast (Atlantic Forest Case Study 3)
...
## A.3 Amazon-Cerrado Transition Case Studies

### A.3.1 Maranhão (Amazon Case Study 1)
...
### A.3.2 Mato Grosso (Amazon Case Study 2)
...
## A.4 Amazon Interior Case Studies

### A.4.1 Eastern Pará (Amazon Case Study 3)
...
### A.4.2 Central Amazon (Amazon Case Study 4)
...
### A.4.3 Western Amazon (Amazon Case Study 5)
...
## A.5 National Context: Protected Areas in Brazil

### A.5.1 Classification and Chronology of Protected Areas
...
### A.5.2 Historical Land Coverage in Protected Areas
...
### A.5.3 Historical Land Coverage in Non-Protected Areas
...
### A.5.4 Deforestation Patterns (2000-Present)
...
## A.6 Case Study Selection Methodology
