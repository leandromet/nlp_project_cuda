#!/usr/bin/env python3
"""
Debug script to check the new Zarr files
"""
...
def debug_zarr_file(zarr_path):
    ...
    try:
        ...
        if 'changes' in root:
            ...
            # Check specifically for 255 values
            count_255 = np.sum(changes == 255)
            if count_255 > 0:
                print(f"Pixels with value 255: {count_255:,} ({100*count_255/total_pixels:.2f}%)")
...
if __name__ == "__main__":
    ...
    test_files = [
        "/media/bndt/db_lin/gitstore/leandromet/nlp_project_cuda/raster_proc/batch_process/indigenous_9/arara_1miLat_3.62685_miLon_53.32525_data.zarr",
        "/media/bndt/db_lin/gitstore/leandromet/nlp_project_cuda/raster_proc/batch_process/indigenous_9/tupiniquim_1miLat_19.87174_miLon_40.17879_data.zarr"
    ]
